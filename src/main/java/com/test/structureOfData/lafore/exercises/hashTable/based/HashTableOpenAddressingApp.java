...
import com.test.structureOfData.lafore.exercises.hashTable.advanced.HashTableChain;
import java.util.Hashtable;

import static com.test.structureOfData.lafore.exercises.hashTable.based.OpenAddressing.*;
